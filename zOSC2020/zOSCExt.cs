...
public static class zOSCExt
{
    ...
    public static System.Type GetPayloadType(this OSCMessage message, int index)
    {
        if (index < 0 || index+1 >= message.typeTag.Length) return null;
        return (zOSCExtentions.GetTypeFromChar(message.typeTag[index + 1]));
