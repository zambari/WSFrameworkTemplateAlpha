...
namespace Z.LayoutPanel
{
    ...
    public class LayoutCreatorAdvanced : MonoBehaviourWithBg
    {
        ...
        void AddLayoutElement(GameObject target, Vector2 preffered)
        {
            ...
            le.minHeight = LayoutBorderControl.setup.topHeight;
            le.minWidth = 3 * LayoutBorderControl.setup.topHeight;
        ...
        LayoutPanel CreatePanel(GameObject parent, string newName = "NoName")
        {
            ...
            creator.bordersPlacedInside = LayoutBorderControl.setup.borderSetup.bordersPlacedInside;
            ...
            contentle.preferredHeight = Random.Range( LayoutBorderControl.setup.topHeight*2,LayoutBorderControl.setup.topHeight * 5);
            creator.RemoveMe();
