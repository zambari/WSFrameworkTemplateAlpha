...
namespace Z.LayoutPanel
{
    ...
    public class LayoutItemCreator : MonoBehaviourWithBg
    {
        ...
        [HideInInspector][SerializeField] protected LayoutTopControl topControl;
        [HideInInspector][SerializeField] protected LayoutPanel panel;
        [HideInInspector][SerializeField] protected LayoutFoldController foldController;
        [HideInInspector][SerializeField] protected Button foldButton;
        [HideInInspector][SerializeField] protected LayoutElement content;
        [HideInInspector][SerializeField] protected LayoutBorderHide layoutBorderHide;
        ...
        public bool bordersPlacedInside = false; //was true
...
#if PALETTES
                topImage.AddOrGetComponent<ColorSync>().presetName = "Top";
#endif
        ...
        public bool addNameMangler = true;
        ...
        public List<LayoutItemCreator> _SubDivdeLayout(int count)
        {
            ...
            if (addNameMangler)
                gameObject.AddOrGetComponent<LayoutNameHelper>();
        ...
        public void AddBordersOnly()
        {
            ...
            // LayoutBorderControl.setup.normalColor =
            ...
            for (int i = count - 1; i >= 0; i--)
            {
                ...
                d.bordersPlacedInside = LayoutBorderControl.setup.borderSetup.bordersPlacedInside;
                if (borderOverScan > 0)
...
//            text.AddOrGetComponent<ColorSync>().presetName = "TopText";
        ...
        void HandleContent()
        {
            ...
            content.minHeight = LayoutBorderControl.setup.topHeight;
            content.minWidth = 26;
...
#endif
#if  UNITY_EDITOR
            UnityEditor.EditorApplication.delayCall += () => Undo.DestroyObjectImmediate(this);
#endif
        }
