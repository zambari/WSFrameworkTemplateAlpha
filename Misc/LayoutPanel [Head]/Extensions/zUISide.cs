...
namespace Z.LayoutPanel
{
    ...
    public enum Side { Top, Left, Right, Bottom, None } //reordered for inspector unicodes
 ...
 return "└═════┘"; // "╘═══╛";
        ...
        public static Vector2 GetPivot(this Side side, bool borderPlacedInside)
        {
            switch (side)
            {
                default:
                    case Side.Top:
                    return borderPlacedInside ? new Vector2(.5f, 1) : new Vector2(0.5f, 0);
                case Side.Left:
                        return borderPlacedInside ? new Vector2(0, .5f) : new Vector2(1, .5f);
                case Side.Right:
                        return borderPlacedInside ? new Vector2(1, .5f) : new Vector2(0, .5f);
                case Side.Bottom:
                        return borderPlacedInside ? new Vector2(0.5f, 0f) : new Vector2(0.5f, 1f);
