...
namespace Z.LayoutPanel
{
    ...
    public class LayoutTopControl : MonoBehaviourWithBg, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerClick(PointerEventData e)
        {
            ...
            {
                var fold = GetComponentInParent<FoldControlBase>();
        ...
        void OnValidate()
        {
            ...
            if (updateName && name != unicodename)
                name = unicodename;
        ...
        void UpdateSize()
        {
            ...
            if (LayoutBorderControl.isReady)
            {
            le.minHeight =  LayoutBorderControl.setup.topHeight;
            le.flexibleWidth = 0.001f;
            le.minWidth = LayoutBorderControl.setup.topHeight * 2;
            le.preferredWidth = LayoutBorderControl.setup.topHeight * 2;
            }
