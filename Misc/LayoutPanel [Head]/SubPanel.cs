...
public class SubPanel : UIBase//, IProvideTopColor//, IContextMenuBuilder
{
	...
	public FoldControlBase foldControl { get { return _foldControl; } set { _foldControl = value; } }

	[SerializeField, HideInInspector]
	FoldControlBase _foldControl;
	protected VerticalLayoutGroup layoutGroup { get { if (_layoutGroup == null) _layoutGroup = GetComponent<VerticalLayoutGroup>(); return _layoutGroup; } }
	...
	Image topImage
	{
		...
		{
			if (_topImage == null)
				if (foldControl != null) _topImage = foldControl.GetComponent<Image>();
			return _topImage;
		}
	}
	...
	void GetParentPanel()
	{
		if (transform.parent != null)
			parentSubPanel = transform.parent.GetComponentInChildren<SubPanel>();
	}
	protected override void Reset()
	{
		base.Reset();
		GetParentPanel();
		foldControl = GetComponentInChildren<FoldControlBase>();
	}
	...
	protected override void OnValidate()
	{
		base.OnValidate();
		GetParentPanel();
		if (foldControl == null) foldControl = GetComponentInChildren<FoldControlBase>();
